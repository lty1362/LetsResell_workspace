...
public class Admin_PageInfo {
	...
	// constructor
	public Admin_PageInfo() {
		
	}
	public Admin_PageInfo(int listCount, int currentPage, int pageLimit, int boardLimit, int maxPage, int startPage,
			int endPage) {
		super();
