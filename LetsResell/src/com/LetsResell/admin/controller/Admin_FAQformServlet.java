...
@WebServlet("/FAQmain.admin")
public class Admin_FAQformServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public Admin_FAQformServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/admin/admin_FAQmain.jsp").forward(request, response);
	}
