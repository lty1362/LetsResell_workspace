...
@WebServlet("/noticeMain.admin")
public class Admin_noticeFormServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public Admin_noticeFormServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/admin/admin_noticeMain.jsp").forward(request, response);
	}
