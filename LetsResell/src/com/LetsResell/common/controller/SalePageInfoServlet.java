...
/**
 * Servlet implementation class SalePageInfoServlet
 */
@WebServlet("/salePageInfo.ajax")
public class SalePageInfoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SalePageInfoServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		gson.toJson(salePi, response.getWriter());
