...
/**
 * Servlet implementation class OldPageInfoServlet
 */
@WebServlet("/oldPageInfo.ajax")
public class OldPageInfoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public OldPageInfoServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		gson.toJson(oldPi, response.getWriter());
	}
