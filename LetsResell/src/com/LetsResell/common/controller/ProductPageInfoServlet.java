...
/**
 * Servlet implementation class ProductPageInfoServlet
 */
@WebServlet("/productPageInfo.ajax")
public class ProductPageInfoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProductPageInfoServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		gson.toJson(productPi, response.getWriter());
	}
