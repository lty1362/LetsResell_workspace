...
<meta charset="UTF-8">
<title>공지사항</title>
<link rel="stylesheet" href="/LetsResell/resources/css/admin/admin_FAQdetailCategory.css">
<style>
...
<body>
	<div id="wrap">
		...
		<div id="body">
		    ...
		    <div id="body_right">
		    	<form action="updateFAQcategory.admin" method="post">
		    		<input type="hidden" name="fno" value="<%=faq.getFAQno() %>">
		    		<input type="hidden" name="category" value="<%=faq.getFAQcategory() %>">
