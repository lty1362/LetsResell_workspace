...
<style>
        ...
        /* 테이블 스타일 */
        .cardInfo-edit-td, .addressInfo-edit-td{font-size: 13px; font-weight: lighter;}
        #cardInfo-edit-tb td, #addressInfo-edit-tb td{padding: 10px;}
</style>
</head>
<body>
	...
	<div id="wrap">
              ...
              <div class="modal-content" style="font-weight: bold;">
                ...
                <div class="modal-body">
                    <div style="margin-top: 10px;">이름
                        <input type="text" class="form-control" placeholder="이름" style="margin-top: 5px; width: 120px;"></div>
                ...
                <div class="modal-body">
                    ...
                    <div style="margin-top: 25px;">
                        <div style="font-size: 13px; font-weight: bold;">
                            ...
                            (8자리 이상으로 패스워드 설정. 영문, 특수문자 포함)</div>
            ...
            <div class="modal-dialog">
              <div class="modal-content" style="font-weight: bold;">
                ...
                <div class="modal-body">
                    ...
                    <div class="text-danger" style="font-size: 13px; font-weight: lighter; margin-top: 50px;" align="center">회원 탈퇴 시 개인 정보 및 LETSRESELL에서 만들어진 모든 데이터는 삭제됩니다.</div>
                    <div class="text-secondary" style="font-size: 13px; font-weight: lighter; margin-top: 5px;" align="center">회원 탈퇴 처리 후에는 회원님의 개인 정보를 복원할 수 없으며, 회원 탈퇴 진행 시 해당 아이디는 영구적으로 삭제되어 재가입이 불가합니다.</div>
                    <div style="float: right; margin-top: 30px;">
                    ...
                    <div style="margin-top: 10px;">
                        <table id="addressInfo-edit-tb">
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control" style="width: 300px; float: left;">
                                </td>
                            </tr>
                            <tr>
                        ...
                        <div><input type="checkbox" style="margin-right: 10px;"><b style="font-size: 13px; font-weight: lighter;">기본배송지로 등록</b></div>
                    </div>
        ...
        <!-- 판매대금 수취 계좌 등록 -->
        <form action="<%= request.getContextPath() %>/updateAccount.my" id="updateAccountForm" method="POST">
            ...
            <div class="modal-dialog">
              <div class="modal-content" style="font-weight: bold;">
                ...
                <div class="modal-body">
                    ...
                    <div style="margin-top: 10px;">
                        <div>
                            <select id="country" name="memBankname" class="form-control" style="font-size: 12px; width: 125px; float: left; margin-top: 3.5px; margin-right: 10px;"> 
                                <option selected>(은행명 선택)</option>
                        ...
                        <div>
                            <input type="text" class="form-control" name="memAccountNo" placeholder="계좌번호" required style="width: 250px; margin-top: 10px;">
                        </div>
                        <div>
                            <input type="text" class="form-control" name="memAccountholder" placeholder="예금주" required style="width: 120px; margin-top: 10px;">
                        </div>
                    </div>

                    <div style="float: right; margin-top: 30px;">
                        <button type="submit" class="btn text-info" data-dismiss="modal" style="font-weight: bold;">저장</button>
                        <button type="button" class="btn text-secondary" data-dismiss="modal" style="font-weight: bold;">취소</button>
                    </div>                     
                </div>
        </div></div></div></form>
